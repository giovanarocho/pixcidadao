...
export function LeafIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M11 20A7 7 0 0 1 4 13c0-5 4-9 12-10 1 8-3 12-9 12" />
      <path d="M4 13c0 5 3 7 7 7" />
    </svg>
  );
}
...
export function PixIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 3v6" />
      <path d="M12 15v6" />
      <path d="m5 12 2.5-2.5a3 3 0 0 1 4.2 0L13 11l1.3-1.5a3 3 0 0 1 4.2 0L21 12l-2.5 2.5a3 3 0 0 1-4.2 0L13 13l-1.3 1.5a3 3 0 0 1-4.2 0L5 12Z" />
    </svg>
  );
}
...
export function CheckBigIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
